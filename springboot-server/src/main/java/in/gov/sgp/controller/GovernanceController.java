...
import in.gov.sgp.service.GovernanceService;
...
public class GovernanceController {
    ...
    public GovernanceController(GovernanceService s) {
        service = s;
    }

    @PostMapping("/auth/register")
    public ResponseEntity<AuthResponse> register(
            @Valid @RequestBody RegisterRequest x
    ) {
        return ResponseEntity.status(201).body(service.register(x));
    }

    @PostMapping("/auth/login")
    public AuthResponse login(
            @Valid @RequestBody LoginRequest x
    ) {
    ...
    public UserDto me(Authentication a) {
        return service.currentDto(a);
    }

    @GetMapping("/users/profile")
    public UserDto profile(Authentication a) {
        return service.currentDto(a);
    }
    ...
    public UserDto updateProfile(
            Authentication a,
            @Valid @RequestBody ProfileUpdateRequest x
    ) {
        return service.updateProfile(a, x);
    }
    ...
    public List<UserDto> users(
        ...
        return service.listUsers(search, role);
    }
    ...
    public ResponseEntity<DepartmentDto> createDepartment(
            @Valid @RequestBody DepartmentRequest x
    ) {
        return ResponseEntity.status(201).body(service.createDepartment(x));
    }
    ...
    public DepartmentDto updateDepartment(
        ...
        return service.updateDepartment(id, x);
    }
    ...
    public ResponseEntity<ComplaintDto> createComplaint(
            Authentication a,
            @Valid @RequestBody ComplaintRequest x
    ) {
        return ResponseEntity.status(201).body(service.createComplaint(a, x));
    }
    ...
    public List<ComplaintDto> my(
        ...
        return service.myComplaints(a, search, status);
    }
    ...
    public List<ComplaintDto> assigned(
        ...
        return service.assigned(a, search, status);
    }
    ...
    public List<ComplaintDto> complaints(
        ...
        return service.allComplaints(search, status, departmentId);
    }
    ...
    public ComplaintDto complaint(
        ...
        return service.getComplaint(a, id);
    }
    ...
    public ComplaintDto updateComplaint(
            Authentication a,
            @PathVariable long id,
            @Valid @RequestBody ComplaintUpdate x
    ) {
    ...
    public ResponseEntity<MessageResponse> contact(
            @Valid @RequestBody ContactRequest x
    ) {
        service.contact(x);

        return ResponseEntity.status(201).body(
                new MessageResponse(
                        "Thank you. Your message has been received by the SGP team."
                )
        );
    }
    ...
    @PreAuthorize("hasRole('CITIZEN')")
    public CitizenDashboard citizenDashboard(Authentication a) {
        return service.citizenDashboard(a);
    }

    @GetMapping("/dashboard/staff")
    @PreAuthorize("hasRole('STAFF')")
    public StaffDashboard staffDashboard(Authentication a) {
        return service.staffDashboard(a);
    }
