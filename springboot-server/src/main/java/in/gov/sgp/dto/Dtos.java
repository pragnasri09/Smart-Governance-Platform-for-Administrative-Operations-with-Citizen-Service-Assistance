...
public final class Dtos {
 ...
 public record ComplaintDto(Long id,String reference,String title,String category,String description,String location,Double latitude,Double longitude,String photoData,ComplaintStatus status,Long citizenId,String citizenName,Long departmentId,String departmentName,Long assignedStaffId,String assignedStaffName,String remarks,String resolution,Instant createdAt,Instant updatedAt){}
